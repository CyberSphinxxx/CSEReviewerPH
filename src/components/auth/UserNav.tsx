    ...
    return (
      <>
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs sm:text-sm font-medium text-slate-700 hover:text-brand-700 rounded-lg hover:bg-slate-100 transition border border-slate-200 shadow-sm"
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-2.5 py-1.5 text-xs sm:text-sm font-medium text-slate-800 shadow-sm hover:bg-slate-50 transition"
      ...
      >
        ...
        <span className="hidden sm:inline-block max-w-[120px] truncate text-slate-700">
      ...
      {dropdownOpen && (
        <div className="absolute right-0 mt-2 w-64 rounded-xl border border-slate-200 bg-white p-2 shadow-xl z-50 animate-in fade-in-50 zoom-in-95 duration-100">
